              ...
              function Barisbaru() {
                  ...
                  var Baris = '<tr>';
                          Baris += '<td>';
                              Baris += '<div class="input-group mb-3 tr">';
                                Baris += '<input type="text" name="rule[]" class="form-control first_name td" placeholder="Input Rule" aria-describedby="button-addon2" alt="Tambah Column Input" required autocomplete="off">';
              ...
              function biodata() {
                  $.ajax({
                      url: 'http://localhost/e-voting/admin/tambah_aturan',
                      type:'post',
                      cache:false,
                      dataType:"json",
