...
<html lang="en">
  ...
  <body>
    ...
    <section class="side">
      <img src="<?= base_url('assets/'); ?>img/img.svg" alt="">
    </section>
    ...
    <section class="mainn">
      <div class="login-container">
        ...
        <form class="login-form was-validated" action="<?= base_url('auth/login'); ?>" method="post">
          <div class="form-control" style="background-color: transparent;">
            <input type="text" name="username" placeholder="NIM" style="border: 1px solid #fff;">
            <div class="icon">
